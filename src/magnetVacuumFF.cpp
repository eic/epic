...
static Ref_t create_detector(Detector& det, xml_h e, SensitiveDetector /* sens */)  {
  ...
  auto pv_b0pf_vacuum = assembly.placeVolume( v_b0pf_vacuum, Transform3D(RotationY(rotation_b0pf), Position(x_b0pf, y_b0pf, z_b0pf)));
  pv_b0pf_vacuum.addPhysVolID("sector", 1);
  DetElement tube_de_1(sdet, "sector1_de", 1);
  tube_de_1.setPlacement(pv_b0pf_vacuum);

  
  auto pv_b0apf_vacuum = assembly.placeVolume( v_b0apf_vacuum, Transform3D(RotationY(rotation_b0apf), Position(x_b0apf, y_b0apf, z_b0apf)));
  pv_b0apf_vacuum.addPhysVolID("sector", 1);
  DetElement tube_de_2(sdet, "sector2_de", 1);
  tube_de_2.setPlacement(pv_b0apf_vacuum);
  

  auto pv_q1apf_vacuum = assembly.placeVolume( v_q1apf_vacuum, Transform3D(RotationY(rotation_q1apf), Position(x_q1apf, y_q1apf, z_q1apf)));
  pv_q1apf_vacuum.addPhysVolID("sector", 1);
  DetElement tube_de_3(sdet, "sector3_de", 1);
  tube_de_3.setPlacement(pv_q1apf_vacuum);

  auto pv_q1bpf_vacuum = assembly.placeVolume( v_q1bpf_vacuum, Transform3D(RotationY(rotation_q1bpf), Position(x_q1bpf, y_q1bpf, z_q1bpf)));
  pv_q1bpf_vacuum.addPhysVolID("sector", 1);
  DetElement tube_de_4(sdet, "sector4_de", 1);
  tube_de_4.setPlacement(pv_q1bpf_vacuum);

  auto pv_q2pf_vacuum = assembly.placeVolume( v_q2pf_vacuum, Transform3D(RotationY(rotation_q2pf), Position(x_q2pf, y_q2pf, z_q2pf)));
  pv_q2pf_vacuum.addPhysVolID("sector", 1);
  DetElement tube_de_5(sdet, "sector5_de", 1);
  tube_de_5.setPlacement(pv_q2pf_vacuum);

  auto pv_b1pf_vacuum = assembly.placeVolume( v_b1pf_vacuum, Transform3D(RotationY(rotation_b1pf), Position(x_b1pf, y_b1pf, z_b1pf)));
  pv_b1pf_vacuum.addPhysVolID("sector", 1);
  DetElement tube_de_6(sdet, "sector6_de", 1);
  tube_de_6.setPlacement(pv_q1apf_vacuum);

  auto pv_b1apf_vacuum = assembly.placeVolume( v_b1apf_vacuum, Transform3D(RotationY(rotation_b1apf), Position(x_b1apf, y_b1apf, z_b1apf)));
