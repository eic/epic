...
static Ref_t create_detector(Detector& det, xml_h e, SensitiveDetector /* sens */) 
{
		...
		xml_coll_t& x_additional_subtraction_i)
	{
		...
		if(name == "downstream")
		{
			...
			lepton_pipe_vac = 
				SubtractionSolid("vacuum_interface_cut_5",
					lepton_pipe_vac,wall_union,Transform3D());
			lepton_pipe_vac = 
				SubtractionSolid("vacuum_interface_cut_6",
					lepton_pipe_vac,coating_union,Transform3D());
