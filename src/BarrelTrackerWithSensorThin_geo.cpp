...
//@}
// clang-format off
DECLARE_DETELEMENT(epic_BarrelTrackerWithSensor_thin, create_BarrelTrackerWithSensor_thin)
DECLARE_DETELEMENT(epic_VertexBarrel_sensor_thin,    create_BarrelTrackerWithSensor_thin)
