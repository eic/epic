...
static Ref_t create_detector(Detector& description, xml_h e, SensitiveDetector sens) {
  ...
  for (xml_coll_t mi(x_det, _U(module)); mi; ++mi, ++m_id) {
    ...
    for (ci.reset(), n_sensor = 1, c_id = 0, posY = -y; ci; ++ci, ++c_id) {
      ...
      pv_overlap_N = m_volume_overlap_N.placeVolume(c_vol_overlap_N, Position(0, posY + c_thick / 2, comp_pos_Zb_N-zbox_N));
      pv_overlap_S = m_volume_overlap_S.placeVolume(c_vol_overlap_S, Position(0, posY + c_thick / 2, comp_pos_Zb_S-zbox_S));
      ...
      double frame_pos_Z_S_out = comp_pos_Z_S + comp_z_S + frame_z_S_out;
        ...
        pv_overlap_N = m_volume_overlap_N.placeVolume(f_vol_overlap_N_in, Position(0, posY + c_thick / 2, frame_pos_Zb_N_in-zbox_N)); 
        pv_overlap_N = m_volume_overlap_N.placeVolume(f_vol_overlap_N_out, Position(0, posY + c_thick / 2, frame_pos_Zb_N_out-zbox_N));
        pv_overlap_S = m_volume_overlap_S.placeVolume(f_vol_overlap_S_in, Position(0, posY + c_thick / 2, frame_pos_Zb_S_in-zbox_S));
        pv_overlap_S = m_volume_overlap_S.placeVolume(f_vol_overlap_S_out, Position(0, posY + c_thick / 2, frame_pos_Zb_S_out-zbox_S));
      }
