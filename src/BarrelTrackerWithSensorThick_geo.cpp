...
//@}
// clang-format off
DECLARE_DETELEMENT(epic_BarrelTrackerWithSensor_thick, create_BarrelTrackerWithSensor_thick)
DECLARE_DETELEMENT(epic_VertexBarrel_sensor_thick,    create_BarrelTrackerWithSensor_thick)
