...
XMLNodePointer_t TGDMLParseBiggerFiles::ConProcess(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString name = "";
   TString value = "";
   TString tempattr;
...
XMLNodePointer_t TGDMLParseBiggerFiles::QuantityProcess(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString name = "";
   TString value = "";
   TString unit = "1.0";
...
XMLNodePointer_t TGDMLParseBiggerFiles::MatrixProcess(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString name = "";
   Int_t coldim = 1;
   std::string values;
...
///
XMLNodePointer_t TGDMLParseBiggerFiles::OpticalSurfaceProcess(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
...
XMLNodePointer_t TGDMLParseBiggerFiles::PosProcess(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
...
XMLNodePointer_t TGDMLParseBiggerFiles::RotProcess(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
...
XMLNodePointer_t TGDMLParseBiggerFiles::SclProcess(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString xpos = "0";
   TString ypos = "0";
   TString zpos = "0";
...
XMLNodePointer_t TGDMLParseBiggerFiles::IsoProcess(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t parentn)
{
   TString z = "0";
   TString name = "";
   TString n = "0";
...
XMLNodePointer_t TGDMLParseBiggerFiles::EleProcess(TXMLEngine *gdml, XMLNodePointer_t node, XMLNodePointer_t parentn,
...
XMLNodePointer_t TGDMLParseBiggerFiles::MatProcess(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr, int z)
{
   ...
   if (z == 1) {
      ...
      if (!mat) {
         ...
         Fatal("TGDMLParseBiggerFiles", "WARNING! Inconsistent material definitions between GDML and TGeoManager");
         return child;
      }
      if (properties.GetSize()) {
         TNamed *property;
...
XMLNodePointer_t TGDMLParseBiggerFiles::SkinSurfaceProcess(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
...
XMLNodePointer_t TGDMLParseBiggerFiles::BorderSurfaceProcess(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
...
XMLNodePointer_t TGDMLParseBiggerFiles::BooSolid(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr, int num)
{
   TString reftemp = "";
   TString tempattr = "";
   XMLNodePointer_t child = gdml->GetChild(node);
...
XMLNodePointer_t TGDMLParseBiggerFiles::Box(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString lunit = fDefault_lunit.c_str();
   bool unitless_l = true;
   TString xpos = "0";
...
XMLNodePointer_t TGDMLParseBiggerFiles::Ellipsoid(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString lunit = fDefault_lunit.c_str();
   bool unitless_l = true;
   TString ax = "0";
...
XMLNodePointer_t TGDMLParseBiggerFiles::ElCone(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString lunit = fDefault_lunit.c_str();
   bool unitless_l = true;
   TString dx = "0";
...
XMLNodePointer_t TGDMLParseBiggerFiles::Paraboloid(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString lunit = fDefault_lunit.c_str();
   bool unitless_l = true;
   TString rlopos = "0";
...
XMLNodePointer_t TGDMLParseBiggerFiles::Arb8(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString lunit = fDefault_lunit.c_str();
   bool unitless_l = true;
   TString v1xpos = "0";
...
XMLNodePointer_t TGDMLParseBiggerFiles::Tube(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString lunit = fDefault_lunit.c_str();
   TString aunit = fDefault_aunit.c_str();
   bool unitless_l = true;
...
XMLNodePointer_t TGDMLParseBiggerFiles::CutTube(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString lunit = fDefault_lunit.c_str();
   TString aunit = fDefault_aunit.c_str();
   bool unitless_l = true;
...
XMLNodePointer_t TGDMLParseBiggerFiles::Cone(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString lunit = fDefault_lunit.c_str();
   TString aunit = fDefault_aunit.c_str();
   bool unitless_l = true;
...
XMLNodePointer_t TGDMLParseBiggerFiles::Trap(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString lunit = fDefault_lunit.c_str();
   TString aunit = fDefault_aunit.c_str();
   bool unitless_l = true;
...
XMLNodePointer_t TGDMLParseBiggerFiles::Trd(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString lunit = fDefault_lunit.c_str();
   bool unitless_l = true;
   TString x1 = "0";
...
XMLNodePointer_t TGDMLParseBiggerFiles::Polycone(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString lunit = fDefault_lunit.c_str();
   TString aunit = fDefault_aunit.c_str();
   bool unitless_l = true;
...
XMLNodePointer_t TGDMLParseBiggerFiles::Polyhedra(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString lunit = fDefault_lunit.c_str();
   TString aunit = fDefault_aunit.c_str();
   bool unitless_l = true;
...
XMLNodePointer_t TGDMLParseBiggerFiles::Sphere(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString lunit = fDefault_lunit.c_str();
   TString aunit = fDefault_aunit.c_str();
   bool unitless_l = true;
...
XMLNodePointer_t TGDMLParseBiggerFiles::Torus(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString lunit = fDefault_lunit.c_str();
   TString aunit = fDefault_aunit.c_str();
   bool unitless_l = true;
...
XMLNodePointer_t TGDMLParseBiggerFiles::Hype(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString lunit = fDefault_lunit.c_str();
   TString aunit = fDefault_aunit.c_str();
   bool unitless_l = true;
...
XMLNodePointer_t TGDMLParseBiggerFiles::Para(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString lunit = fDefault_lunit.c_str();
   TString aunit = fDefault_aunit.c_str();
   bool unitless_l = true;
...
XMLNodePointer_t TGDMLParseBiggerFiles::TwistTrap(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString lunit = fDefault_lunit.c_str();
   TString aunit = fDefault_aunit.c_str();
   bool unitless_l = true;
...
XMLNodePointer_t TGDMLParseBiggerFiles::ElTube(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString lunit = fDefault_lunit.c_str();
   bool unitless_l = true;
   TString xpos = "0";
...
XMLNodePointer_t TGDMLParseBiggerFiles::Orb(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString lunit = fDefault_lunit.c_str();
   bool unitless_l = true;
   TString r = "0";
...
XMLNodePointer_t TGDMLParseBiggerFiles::Xtru(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
   TString lunit = fDefault_lunit.c_str();
   bool unitless_l = true;
   TString x = "0";
...
XMLNodePointer_t TGDMLParseBiggerFiles::Tessellated(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
...
XMLNodePointer_t TGDMLParseBiggerFiles::ScaledSolid(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
...
XMLNodePointer_t TGDMLParseBiggerFiles::Reflection(TXMLEngine *gdml, XMLNodePointer_t node, XMLAttrPointer_t attr)
{
