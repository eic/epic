...
//@}
// clang-format off
DECLARE_DETELEMENT(epic_BarrelTrackerWithSensor, create_BarrelTrackerWithSensor)
DECLARE_DETELEMENT(epic_VertexBarrel_sensor,    create_BarrelTrackerWithSensor)
