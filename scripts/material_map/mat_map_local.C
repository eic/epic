...
void mat_map_local(std::string Val = "", std::string geantino = "", std::string name = "") {
  ...
  TProfile* Val_X0_Eta = new TProfile("Val_X0_Eta", "Val_X0_Eta", 160, -4, 7);
  TProfile* Val_X0_Phi = new TProfile("Val_X0_Phi", "Val_X0_Phi", 160, -4, 7);
  TH2F* Val_X0         = new TH2F("Val_X0", "Val_X0", 160, -4, 7, 160, -4, 7);

  TProfile* geantino_X0_Eta = new TProfile("geantino_X0_Eta", "geantino_X0_Eta", 160, -4, 7);
  TProfile* geantino_X0_Phi = new TProfile("geantino_X0_Phi", "geantino_X0_Phi", 160, -4, 7);
  TH2F* geantino_X0         = new TH2F("geantino_X0", "geantinol_X0", 160, -4, 7, 160, -4, 7);

  TH1F* comp_X0_Eta = new TH1F("comp_X0_Eta", "comp_X0_Eta", 160, -4, 7);
  TH1F* comp_X0_Phi = new TH1F("comp_X0_Phi", "comp_X0_Phi", 160, -4, 7);
  TH2F* comp_X0     = new TH2F("comp_X0", "comp_X0", 160, -4, 7, 160, -4, 7);

  TH2F* mat_map1 = new TH2F("mat_map1", "", 2000, -3000, 8000, 1000, -10, 1000);
  TH2F* mat_map2 = new TH2F("mat_map2", "", 2000, -3000, 8000, 1000, -10, 1000);
  ...
  Val_file->Draw("sqrt(mat_x**2+mat_y**2):v_eta", "(mat_z>-5000)&(mat_z<8000)");
  VM_eta->SetGrid();
  ...
  geantino_file->Draw("sqrt(mat_x**2+mat_y**2):mat_z>>mat_map2", "(mat_z>-5000)&(mat_z<8000)");
...
void Mat_map(std::string Val = "", std::string geantino = "", std::string name = "") {
  ...
  TH2F* Val_X0_Eta_spread =
      new TH2F("Val_X0_Eta_spread", "Val_X0_Eta_spread", 160, -4, 4, 160, 0, 4);
  TH2F* Val_X0_Phi_spread =
      new TH2F("Val_X0_Phi_spread", "Val_X0_Phi_spread", 160, -4, 4, 160, 0, 4);
  ...
  TH2F* geantino_X0_Eta_spread =
      new TH2F("geantino_X0_Eta_spread", "geantino_X0_Eta_spread", 160, -4, 4, 160, 0, 4);
  TH2F* geantino_X0_Phi_spread =
      new TH2F("geantino_X0_Phi_spread", "geantino_X0_Phi_spread", 160, -4, 4, 160, 0, 4);
