...
python material_validation_epic.py --xmlFile ${DETECTOR_PATH}/${DETECTOR_CONFIG}.xml --outputName ${propFile}_regenerated --matFile material-map_map.json -n ${nevents}  -t ${nparticles}
...
# FIXME: Surface plot scripts require geometry JSON parsing
# Disabled temporarily due to JSON format incompatibility between v45.3.0 and v46.8.1
