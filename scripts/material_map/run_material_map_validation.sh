...
curl --location https://github.com/acts-project/acts/pull/4931.diff | git apply -p1
curl --location https://github.com/acts-project/acts/pull/5046.diff | git apply -p1
